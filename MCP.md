...
### 2.1 구성 요소
![](https://velog.velcdn.com/images/gitit-sehyeon/post/6a29b7e3-d1cd-4d68-9915-4cc048ab7851/image.png)
...
![](https://velog.velcdn.com/images/gitit-sehyeon/post/e8b82590-277b-4595-afb8-99f7f93cf897/image.png)![](https://velog.velcdn.com/images/gitit-sehyeon/post/6ac6fc4c-9b96-4d42-86fd-7d2c1ba08cf7/image.png)
...
| **Code Execution with MCP** | Anthropic, 2025-11 | ~98.7% | 서버를 import 가능한 TS 모듈로 제시, 샌드박스에서 코드 실행 (150K → 2K 토큰) / 툴 설명을 아예 안 주고, 대신 **"이 서버는 이런 함수를 가진 코드 라이브러리다"** / AI는 사람 개발자처럼 코드를 직접 짜서 그 함수들을 불러 쓴다.|
